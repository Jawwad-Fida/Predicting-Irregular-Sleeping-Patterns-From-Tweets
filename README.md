...
We used Bidirectional Encoder Representations from Transformers (BERT) to generate contextualized word embeddings. We generated BERT vectors using a pre-trained model named Bert-based-uncased from the sentence-transformers library. The tweet sentences were converted into a 768-dimensional vector space. Shape of the data after word embedding is 924x768. BERT word embeddings is our final dataset which contains both psycholinguistic and word embedding–based analyses regarding the users' tweets. These analysis are the independent variables, while the dependent variable is Irregular Sleep Yes and Irregular Sleep No. 

```Python
! pip install git+https://github.com/khalidsaifullaah/BERTify

# Calling BERTify -> using bert-based-uncased

def bert_embedding(text2):
  ...
  en_embeddings = en_bertify.embedding(text2)
...
<img src="https://user-images.githubusercontent.com/64092765/189373839-677f4f36-9242-4306-9958-e9740baae6c1.png" width="50%">

# Results

![Results of models](https://user-images.githubusercontent.com/64092765/180458405-98cc104d-d826-447a-bea4-d5c679f13064.png)

## Learning curves of the models

<img src="https://user-images.githubusercontent.com/64092765/189373926-85ed7f79-18c0-492f-89d8-27b2481bcb62.png" width="50%">
